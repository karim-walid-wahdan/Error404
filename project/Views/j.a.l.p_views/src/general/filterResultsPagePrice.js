...
function FilterResultsPagePrice() {


   let searchResult=sessionStorage.getItem("filterResult")
   console.log(searchResult.split(",").length)
...
export default FilterResultsPagePrice;